...
user in an INI file next to JDownloaderPortable.exe called JDownloaderPortable.ini.
...
copy AppNamePortable.ini from this directory to JDownloaderPortable.ini next to
JDownloaderPortable.exe. The options in the INI file are as follows:
